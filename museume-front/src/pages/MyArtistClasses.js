...
const ArtistList = () => {
  ...
  useEffect(() => {
    dispatch(getMyArtistClasses({ page, search, is_free: feeFilter, class_type: classTypeFilter }));
  ...
  const handleSearch = () => {
    ...
    dispatch(getMyArtistClasses({ page: 1, search, is_free: feeFilter, class_type: classTypeFilter }));
  };

  const handlePageChange = (newPage) => {
    setPage(newPage);
    dispatch(getMyArtistClasses({ page: newPage, search, is_free: feeFilter, class_type: classTypeFilter }));
  };
  ...
  const handleFeeFilterChange = (value) => {
    ...
    dispatch(getMyArtistClasses({ page: 1, search, is_free: value, class_type: classTypeFilter }));
  };

  const handleClassTypeFilterChange = (value) => {
    setClassTypeFilter(value);
    setPage(1); // Reset page to 1 when filter changes
    dispatch(getMyArtistClasses({ page: 1, search, is_free: feeFilter, class_type: value }));
  };
